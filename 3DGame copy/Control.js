...
(function (FudgeCraftCopy) {
    ...
    class Control extends ƒ.Node {
        ...
        checkCollisions(_transformation) {
            ...
            for (let cube of this.fragment.getChildren()) {
                let element = FudgeCraftCopy.grid.pull(cube.mtxWorld.translation);
                if (element)
        ...
        freeze() {
            ...
            for (let cube of this.fragment.getChildren()) {
                ...
                let element = new FudgeCraftCopy.GridElement(cube);
                FudgeCraftCopy.grid.push(position, element);
                frozen.push(element);
            }
            return frozen;
        }
    ...
    FudgeCraftCopy.Control = Control;
